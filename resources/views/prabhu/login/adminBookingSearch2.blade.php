...
@endpush
		...
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Bookings Search</li>
			</ol>
		</div><!--/.row-->
						...
						<table id="package_search" class="display" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ url("/tour-view")}}/<?php echo base64_encode($row->tour_id) ;?>" traget="_blank" class="btn btn-sm btn-success pksr-btn"> View </a><br>
