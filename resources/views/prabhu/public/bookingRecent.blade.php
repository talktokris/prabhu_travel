      ...
      <div class="col-md-6">
        <div class="recom-item border">
          <div class="recom-media"><a href="{{ url('/tour-view')}}/{{ $hash_id }}">
              <div class="pic"><img src="{{ $img_location }}" data-at2x="{{ $img_location }}" alt="{{  $sRow->tour_title }}"></div></a>
    ...
    <div class="container">
      <div class="call-out-box">
        <div class="call-out-wrap alt">
          <h2 class="title-section alt-2 gray">Do you have questions?</h2><a href="contact.php" class="cws-button border-left large alt mb-20">Contact us</a>
        </div>
      </div>
    </div>
  </section>
