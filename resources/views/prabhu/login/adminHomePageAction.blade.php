                    ...
                    <div class="panel-heading">Create New Tour Destinations</div>
                        <div class="panel-body">
                            <div class="col-md-6">
                                ...
                                <form method="POST" action="{{ url('/pb/admin/home-status-action') }}/<?php echo base64_encode($fillRow->id) ;?>">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        <label>Home Page Status :</label>
                                        <?php if(($fillRow->home_page_staus)==1){ $statusText='Seen';}
                                        elseif (old('status')==1) { $statusText='Seen';}
                                        else {
                                            $statusText='Not Seen';
                                        }
                                        ?>
