				...
				<div class="col-xs-6 col-md-4 col-lg-4 no-padding">
					<div class="panel panel-teal panel-widget border-right">
						<div class="row no-padding"><em class="fa fa-xl fa-list color-blue"></em>
							<div class="large">{{ $allPac}}</div>
							<div class="text-muted">Total Tour Packages</div>
						</div>
					</div>
				</div>
				<div class="col-xs-6 col-md-4 col-lg-4 no-padding">
					<div class="panel panel-blue panel-widget border-right">
						<div class="row no-padding"><em class="fa fa-xl fa-check-circle color-teal"></em>
							<div class="large">{{ $activePac }}</div>
							<div class="text-muted">Active  Tour Packages</div>
						</div>
					</div>
				</div>
				<div class="col-xs-6 col-md-4 col-lg-4 no-padding">
					<div class="panel panel-orange panel-widget border-right">
						<div class="row no-padding"><em class="fa fa-xl fa-clock-o color-orange"></em>
							<div class="large">{{ $pendingPac }}</div>
							<div class="text-muted">Pending Tour Packages</div>
						</div>
					</div>
				</div>
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
                        ...
                        <div class="col-lg-12">
                            <h3 class="page-header">Recent Bookings</h3>
                        </div>
						<div class="col-md-12">
